...
export const routes = {
    ...
    AdminChartsRoute: {
        to: "/admin/chart",
        build: (options) => interpolatePath("/admin/chart", undefined, options?.search, options?.hash),
    },
    AdminFormElementsRoute: {
        to: "/admin/forms/form-elements",
        build: (options) => interpolatePath("/admin/forms/form-elements", undefined, options?.search, options?.hash),
    },
    AdminFormLayoutsRoute: {
        to: "/admin/forms/form-layouts",
        build: (options) => interpolatePath("/admin/forms/form-layouts", undefined, options?.search, options?.hash),
    },
    AdminCalendarRoute: {
        to: "/admin/calendar",
    ...
    AdminUIAlertsRoute: {
        to: "/admin/ui/alerts",
        build: (options) => interpolatePath("/admin/ui/alerts", undefined, options?.search, options?.hash),
    },
    AdminUIButtonsRoute: {
        to: "/admin/ui/buttons",
