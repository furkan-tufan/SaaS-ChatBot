...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (<aside ref={sidebar} className={cn('absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-gray-800 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0', {
        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              {/* <!-- Menu Item Dashboard --> */}
              <NavLink to='/admin' end className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
            'bg-gray-700 dark:bg-meta-4': isActive,
              ...
              {/* <!-- Menu Item Users --> */}
              <li>
                <NavLink to='/admin/users' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
            'bg-gray-700 dark:bg-meta-4': isActive,
        })}>
              ...
              {/* <!-- Menu Item Settings --> */}
              <li>
                <NavLink to='/admin/settings' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
            'bg-gray-700 dark:bg-meta-4': isActive,
        })}>
                  <svg className='fill-current' width='18' height='19' viewBox='0 0 18 19' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              {/* <!-- Menu Item Chart --> */}
              <li>
                <NavLink to='/admin/chart' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
            'bg-gray-700 dark:bg-meta-4': isActive,
        })}>
                  <svg className='fill-current' width='18' height='19' viewBox='0 0 18 19' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            return (<React.Fragment>
                      <NavLink to='#' className={cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
                    ...
                    sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                        ...
                        Forms
                        <svg className={cn('absolute right-4 top-1/2 -translate-y-1/2 fill-current', {
                    'rotate-180': open,
                      ...
                      <div className={cn('translate transform overflow-hidden', { hidden: !open })}>
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                          <li>
                            <NavLink to='/admin/forms/form-elements' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white', { '!text-white': isActive })}>
                              Form Elements
                            </NavLink>
                          </li>
                          <li>
                            <NavLink to='/admin/forms/form-layouts' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white', { '!text-white': isActive })}>
                              Form Layout
                            </NavLink>
                          </li>
                        </ul>
              ...
              {/* <!-- Menu Item Calendar --> */}
              <li>
                <NavLink to='/admin/calendar' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 dark:hover:bg-meta-4', {
            'bg-gray-700 dark:bg-meta-4': isActive,
        })}>
                  <svg className='fill-current' width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            return (<React.Fragment>
                    ...
                    'rotate-180': open,
                      ...
                      <div className={cn('translate transform overflow-hidden', { hidden: !open })}>
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                          <li>
                            <NavLink to='/admin/ui/alerts' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white', { '!text-white': isActive })}>
                              Alerts
                            </NavLink>
                          </li>
                          <li>
                            <NavLink to='/admin/ui/buttons' className={({ isActive }) => cn('group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white', { '!text-white': isActive })}>
                              Buttons
                            </NavLink>
                          </li>
                        </ul>
